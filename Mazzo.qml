...
Item {
    ...
    ListModel {
        ...
        ListElement { name : "Alfiere1"; image : "alfiere.png" }
        ListElement { name : "Alfiere2"; image : "alfiere.png" }
        ListElement { name : "Alfiere3"; image : "alfiere.png" }
        ListElement { name : "Alfiere4"; image : "alfiere.png" }
        ListElement { name : "Alfiere5"; image : "alfiere.png" }
        ListElement { name : "Alfiere6"; image : "alfiere.png" }
        ListElement { name : "Alfiere7"; image : "alfiere.png" }
        ListElement { name : "Alfiere8"; image : "alfiere.png" }
        ListElement { name : "Alfiere9"; image : "alfiere.png" }
        ListElement { name : "Alfiere0"; image : "alfiere.png" }
        ListElement { name : "Alfiere1"; image : "alfiere.png" }
        ListElement { name : "Alfiere2"; image : "alfiere.png" }
        ListElement { name : "Alfiere3"; image : "alfiere.png" }
        ListElement { name : "Alfiere4"; image : "alfiere.png" }
